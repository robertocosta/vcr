 ...
 *
 * Code generation for function '_coder_getPath_api'
 *
 */
...
void getPath_api(const mxArray * const prhs[1], const mxArray *plhs[1])
{
  emxArray_real_T *D;
  emxArray_real_T *p;
...
/* End of code generation (_coder_getPath_api.c) */
