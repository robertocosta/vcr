...
void getPath(const emlrtStack *sp, const emxArray_real_T *D, emxArray_real_T *p)
{
  ...
  if ((D->size[1] == 1) && (D->size[0] == 1)) {
    ...
    for (ix = 0; ix < 2; ix++) {
      for (i3 = 0; i3 < 2; i3++) {
        p->data[i3 + p->size[0] * ix] = dv0[i3 + (ix << 1)];
      }
    }
  } else if (D->size[0] == 1) {
    for (ix = 0; ix < 2; ix++) {
    ...
    i3 = D->size[0] - 1;
    if (!((i3 >= 1) && (i3 <= ix))) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, ix, &tb_emlrtBCI, sp);
    }
    ...
    b_varargin_1[0] = D->data[(i3 + D->size[0] * (ixstart - 1)) - 1];
    ix = D->size[0];
    i3 = D->size[0];
    if (!((i3 >= 1) && (i3 <= ix))) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, ix, &vb_emlrtBCI, sp);
    }
    ...
    b_varargin_1[1] = D->data[(i3 + D->size[0] * (ixstart - 1)) - 1];
    ix = D->size[0];
    i3 = D->size[0] - 1;
    if (!((i3 >= 1) && (i3 <= ix))) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, ix, &xb_emlrtBCI, sp);
    }
    ...
    b_varargin_1[2] = D->data[(i3 + D->size[0] * (ixstart - 1)) - 1];
    ixstart = 1;
    mtmp = b_varargin_1[0];
    itmp = 1;
    ...
    switch (itmp) {
     case 1:
      ...
      for (ix = 0; ix < itmp; ix++) {
        for (i3 = 0; i3 < ixstart; i3++) {
          b_D->data[i3 + b_D->size[0] * ix] = D->data[i3 + D->size[0] * ix];
        }
      }
      ...
      for (ix = 0; ix < 2; ix++) {
        for (i3 = 0; i3 < ixstart; i3++) {
          p->data[i3 + p->size[0] * ix] = varargin_1->data[i3 + ixstart * ix];
        }
      }
     ...
     case 2:
      ...
      i3 = D->size[0];
      if (!((i3 >= 1) && (i3 <= ix))) {
        emlrtDynamicBoundsCheckR2012b(i3, 1, ix, &nb_emlrtBCI, sp);
      }
      ...
      for (ix = 0; ix < ixstart; ix++) {
        for (i3 = 0; i3 < itmp; i3++) {
          c_D->data[i3 + c_D->size[0] * ix] = D->data[i3 + D->size[0] * ix];
        }
      }
     ...
     case 3:
      ...
      i3 = D->size[1];
      if (!((i3 >= 1) && (i3 <= ix))) {
        emlrtDynamicBoundsCheckR2012b(i3, 1, ix, &hb_emlrtBCI, sp);
      }
      ...
      for (ix = 0; ix < itmp; ix++) {
        for (i3 = 0; i3 < ixstart; i3++) {
          d_D->data[i3 + d_D->size[0] * ix] = D->data[i3 + D->size[0] * ix];
        }
      }
