 ...
 *
 * Code generation for function '_coder_predict_api'
 *
 */
...
void predict_api(const mxArray * const prhs[2], const mxArray *plhs[1])
{
  ...
  classe = predict(&st, mfcc1, &mfccTab);
