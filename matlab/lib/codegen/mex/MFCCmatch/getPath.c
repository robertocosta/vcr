...
static emlrtRTEInfo g_emlrtRTEI = { 281,/* lineNo */
  27,                                  /* colNo */
  "cat",                               /* fName */
...
void getPath(const emlrtStack *sp, const emxArray_real_T *D, emxArray_real_T *p)
{
  ...
  p->size[0] = 1;
  p->size[1] = 1;
  emxEnsureCapacity_real_T(sp, p, ix, &e_emlrtRTEI);
  p->data[0] = 0.0;
  emxInit_real_T(sp, &varargin_1, 2, &e_emlrtRTEI, true);
  emxInit_real_T(sp, &b_D, 2, &e_emlrtRTEI, true);
  emxInit_real_T(sp, &c_D, 2, &e_emlrtRTEI, true);
  emxInit_real_T(sp, &d_D, 2, &e_emlrtRTEI, true);
  if ((D->size[1] == 1) && (D->size[0] == 1)) {
    ...
    switch (itmp) {
     case 1:
      ...
      b_D->size[0] = ixstart;
      b_D->size[1] = itmp;
      emxEnsureCapacity_real_T(sp, b_D, ix, &e_emlrtRTEI);
      for (ix = 0; ix < itmp; ix++) {
     ...
     case 2:
      ...
      c_D->size[0] = itmp;
      c_D->size[1] = ixstart;
      emxEnsureCapacity_real_T(sp, c_D, ix, &e_emlrtRTEI);
     ...
     case 3:
      ...
      d_D->size[0] = ixstart;
      d_D->size[1] = itmp;
      emxEnsureCapacity_real_T(sp, d_D, ix, &e_emlrtRTEI);
      for (ix = 0; ix < itmp; ix++) {
        for (i2 = 0; i2 < ixstart; i2++) {
